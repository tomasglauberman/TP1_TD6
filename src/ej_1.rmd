...
Se debe transformar la columna de "Blood pressure" que viene dada en el formato yyy/xx a 2 columnas diferentes una para cada valor: yyy, xx. Por otro lado, se debe transformar la columna "Sleep disorder" en etiquetas binarias: posee o no algún sleep disorder.
